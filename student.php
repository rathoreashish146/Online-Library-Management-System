...
<div id="mySidenav" class="sidenav">
  ...
  <div class="h"><a href="profile1.php">Profile</a></div>
  ...
  document.getElementById("main").style.marginLeft= "0";
   ...
   <!------------------search bar------------  -->
      <div class="srch"> 
       ...
       <h2 style="margin-left: 40%; margin-bottom: 10px; font-size: 40px;">STUDENT-INFORMTION</h2>
       
       <?php
            
            if(isset($_POST['submit'])){
               $q = mysqli_query($db,"SELECT * FROM student WHERE facultyNo LIKE '%$_POST[search]%' ");
